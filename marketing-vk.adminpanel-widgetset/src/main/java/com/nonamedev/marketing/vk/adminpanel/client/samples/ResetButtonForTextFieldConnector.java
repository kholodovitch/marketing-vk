package com.nonamedev.marketing.vk.adminpanel.client.samples;
...
import com.nonamedev.marketing.vk.adminpanel.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
	...
	/*-{
	    ...
	    el.onclick = $entry(function () {
	        self.@com.nonamedev.marketing.vk.adminpanel.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
	    });
	}-*/;
