...
- marketing-vk.adminpanel-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- marketing-vk.adminpanel-ui: main application module, development time
- marketing-vk.adminpanel-production: module that produces a production mode WAR for deployment
