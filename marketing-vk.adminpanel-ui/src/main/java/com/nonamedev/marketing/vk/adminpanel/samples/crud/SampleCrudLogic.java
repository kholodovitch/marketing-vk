package com.nonamedev.marketing.vk.adminpanel.samples.crud;

import java.io.Serializable;

import com.nonamedev.marketing.vk.adminpanel.DashboardUI;
import com.nonamedev.marketing.vk.adminpanel.samples.backend.DataService;
...
public class SampleCrudLogic implements Serializable {
	...
	public void init() {
		...
		if (!DashboardUI.get().getAccessControl().isUserInRole("admin")) {
	...
	private void setFragmentParameter(String productId) {
		...
		Page page = DashboardUI.get().getPage();
		page.setUriFragment(
